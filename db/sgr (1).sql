...
--
-- Host: 127.0.0.1
-- Tempo de geração: 22-Nov-2022 às 10:48
...
CREATE TABLE `formacao` (
  ...
  `id_tipocurso` int(11) DEFAULT NULL,
...
INSERT INTO `tipovinculo` (`idRegime`, `tipo`, `dt_inativacao`) VALUES
...
--
ALTER TABLE `cre`
  MODIFY `idCre` int(11) NOT NULL AUTO_INCREMENT;
