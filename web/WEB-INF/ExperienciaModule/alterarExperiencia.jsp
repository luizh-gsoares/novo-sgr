...
<%%>
  ...
  <div class="content-wrapper">
    ...
    <form class="needs-validation" novalidate action="alterarexperiencia" method="post">
        ...
        <div class="row mb-4">
            <div class="col">
                <div class="form-outline">
                    <input type="hidden" id="form6Example1" class="form-control" id="validationCustom01" name="idExperiencia" />
                </div>
            </div>
            <div class="col">
                <div class="form-outline">                          
