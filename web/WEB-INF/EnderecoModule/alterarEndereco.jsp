                    ...
                    <div class="col">
                        <div class="form-outline">
                          ...
                          <input type="text" id="form6Example1" class="form-control" id="validationCustom01"
                            name="cep" value="${endereco.cep}" />  ${endereco.cep}
                        </div>
                      </div>
                    <div class="col">
                      <div class="form-outline">
                        <label class="form-label" for="form6Example1">Logradouro</label>
                        <input type="text" id="form6Example1" class="form-control" id="validationCustom01" name="logradouro" value="${endereco.logradouro}" /> ${endereco.logradouro}
                      </div>
                    </div> 
                    <div class="col">
                      <div class="form-outline">
                        ...
                        <input type="text" id="form6Example1" class="form-control" id="validationCustom01"
                          name="complemento" value="${endereco.complemento}"/> ${endereco.complemento}
                      </div>
                    </div>
                    <div class="col">
                      <div class="form-outline">
