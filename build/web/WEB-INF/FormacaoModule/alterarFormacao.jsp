    ...
    <form class="needs-validation" novalidate action="alterarformacao" method="post">
      ...
      <div class="container">
        ...
        <div class="row mb-4">
          ...
          <div class="col">
            <div class="form-outline">
              <label class="form-label" for="form6Example1">id_tipocurso</label>
          ...
          <div class="col">
            <div class="form-outline">
              ...
              <input type="text" id="form6Example1" class="form-control" id="validationCustom01"
                name="Instituição" value="${formacao.instituição}"/> ${formacao.instituição}
            </div>
          </div>
          <div class="col">
            <div class="form-outline">
              ...
              <input type="text" id="form6Example1" class="form-control" id="validationCustom01"
                name="semestre" value="${formacao.semestre}" /> ${formacao.semestre}
            </div>
          </div>
          <div class="col">
            <div class="form-outline">
              ...
              <input type="date" id="form6Example1" class="form-control" id="validationCustom01"
                name="dtIncio" value="${formacao.dtIncio}" /> ${formacao.dtIncio}
            </div>
          </div>
          <div class="col">
            <div class="form-outline">
              <label class="form-label" for="form6Example1" required>Semestre Atual</label>
              <input type="date" id="form6Example1" class="form-control" id="validationCustom01"
                name="dtFim" value="${formacao.dtFim}" />${formacao.dtFim}
            </div>
          </div>
        </div>
