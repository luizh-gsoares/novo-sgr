                ...
                <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1" id="fundomenu">
                    ...
                    <form action="cadastrarusuario" method="post"  needs-validation">
                        <div class="pb-5" align="center"><span>
                                <h1 class="display-6">Alterar Usuário</h1>
                            </span></div>

                        <!-- lOGIN input -->
                        <div class="col">
                            <label for="validationCustom01" class="form-label">Nome de usuário</label>
                            <input type="text" class="form-control" id="validationCustom01" name="login"   
                                   oninvalid="this.setCustomValidity('Digite um nome de usuário válido')"  value="${usuario.login}"
                                   onchange="try {
                                               setCustomValidity('')
                                           } catch (e) {
                                           }">
